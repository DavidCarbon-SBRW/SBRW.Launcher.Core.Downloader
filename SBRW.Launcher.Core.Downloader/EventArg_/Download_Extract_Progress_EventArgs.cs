...
namespace SBRW.Launcher.Core.Downloader.EventArg_
{
    ...
    public class Download_Extract_Progress_EventArgs : EventArgs
    {
        ...
        public Download_Extract_Progress_EventArgs(int Received_Extract_Percentage, string Received_Extract_File_Name, int Received_File_Total, int Received_File_Current, DateTime Received_Time)
        {
